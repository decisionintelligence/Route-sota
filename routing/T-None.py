        ...
        for pairs in r_pairs:
            ...
            for pair_ in pairs:
                ...
                for t_b_, t_b in enumerate([0.5, 0.75, 1.0, 1.25, 1.5]):
                    ...
                    best_p, best_w, all_rounds, all_expire = self.rout(start, desti, edge_desty, vedge_desty, path_desty, nodes_order, U, G2, points, speed_dict)
...
if __name__ == '__main__':
    try:
        ...
        parser = argparse.ArgumentParser(description='V-None')
        ...
        parser = argparse.ArgumentParser(description='T-None')
        ...
        pace_rout = PaceRout(fpath, time_budget, fpath_desty, fedge_desty, subpath, axes_file, speed_file, sigma, eta, query_name)
        pace_rout.main()
